...
public class TerrainGenerator : MonoBehaviour
{
    ...
    public Gradient lavaGradient;
    public Gradient snowGradient;
    public Gradient islandGradient;
    public Gradient flatlandGradient;
    ...
    [Range(1, 15)] public int octaves = 1;
    ...
    private Color EvaluateColor(Triangle triangle)
    {
        ...
        switch (colorSetting)
        {
            ...
            case ColorSetting.Lava:
                currentHeight = (currentHeight < 0f) ? currentHeight / heightScale * 10f : currentHeight / heightScale;
                var gradientVal2 = Mathf.InverseLerp(minNoiseHeight, maxNoiseHeight, currentHeight);
                return lavaGradient.Evaluate(gradientVal2);

            case ColorSetting.Snow:
                currentHeight = (currentHeight < 0f) ? currentHeight / heightScale * 10f : currentHeight / heightScale;
                var gradientVal3 = Mathf.InverseLerp(minNoiseHeight, maxNoiseHeight, currentHeight);
                return snowGradient.Evaluate(gradientVal3);

            case ColorSetting.Island:
                currentHeight = (currentHeight < 0f) ? currentHeight / heightScale * 10f : currentHeight / heightScale;
                var gradientVal4 = Mathf.InverseLerp(minNoiseHeight, maxNoiseHeight, currentHeight);
                return islandGradient.Evaluate(gradientVal4);

            case ColorSetting.Flatland:
                currentHeight = (currentHeight < 0f) ? currentHeight / heightScale * 10f : currentHeight / heightScale;
                var gradientVal5 = Mathf.InverseLerp(minNoiseHeight, maxNoiseHeight, currentHeight);
                return flatlandGradient.Evaluate(gradientVal5);
        }
